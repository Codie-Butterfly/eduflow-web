...
import { StudentPortalService, StudentGrade, StudentGradesResponse } from '../services/student-portal.service';
...
export class StudentGradesComponent implements OnInit {
  ...
  loadGrades(): void {
    ...
    this.studentService.getGrades(startDateStr, endDateStr).subscribe({
      next: (response) => {
