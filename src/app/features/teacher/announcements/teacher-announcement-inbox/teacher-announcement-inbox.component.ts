...
@Component({
  selector: 'app-teacher-announcement-inbox',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './teacher-announcement-inbox.component.html',
  styleUrl: './teacher-announcement-inbox.component.scss'
})
export class TeacherAnnouncementInboxComponent implements OnInit {
  ...
  loadAnnouncements(): void {
    ...
    this.announcementService.getInboxAnnouncements(0, 50, this.showUnreadOnly).subscribe({
      next: (response) => {
