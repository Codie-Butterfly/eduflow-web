...
import { ParentAnnouncementService } from '../services/parent-announcement.service';
import { FileUploadService } from '../../../shared/services/file-upload.service';
import { Announcement, AnnouncementPriority } from '../../../core/models';

@Component({
  selector: 'app-parent-announcement-inbox',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './parent-announcement-inbox.component.html',
  styleUrl: './parent-announcement-inbox.component.scss'
})
export class ParentAnnouncementInboxComponent implements OnInit {
  private announcementService = inject(ParentAnnouncementService);
  private fileUploadService = inject(FileUploadService);

  announcements = signal<(Announcement & { isRead: boolean; childName?: string })[]>([]);
  selectedAnnouncement = signal<(Announcement & { isRead: boolean; childName?: string }) | null>(null);
  ...
  selectAnnouncement(announcement: Announcement & { isRead: boolean; childName?: string }): void {
